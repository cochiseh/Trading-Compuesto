...
// alert("Script cargado OK. Iniciando..."); // Comentado para no molestar si funciona, descomentar si necesario.
...
async function handleAuthSubmit(e) {
    e.preventDefault();
    alert("Botón presionado. Intentando conectar..."); // DIAGNÓSTICO
